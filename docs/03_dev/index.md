...
Les grands chapitres de cette politique sont organisés en reprenant le cycle de vie du développement d’un logiciel : [conception](./design/), [développement](./development/), [tests](./test/), [intégration / déploiement](./ci-cd/), [documentation](./documentation/), et [décommissionnement](./decommissioning/). 
